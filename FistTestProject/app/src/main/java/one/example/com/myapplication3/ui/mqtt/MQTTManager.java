package one.example.com.myapplication3.ui.mqtt;
...
/**
 * wake up:
 * mqtt协议：https://www.jianshu.com/p/f84568a69b53
 *
 * wake up:
 * mqtt协议 Android ：https://juejin.cn/post/6896643663766978567
 *
 * wake up:
 * mqtt协议中文介绍：https://mcxiaoke.gitbooks.io/mqtt-cn/content/mqtt/02-ControlPacketFormat.html
 */
public class MQTTManager {
    ...
    private static Application mApplictaion;
     ...
     */
    public static MQTTManager getInstance(Application context) {
        mApplictaion = context;
...
//            try {
//                sslSocketFactory = sslContextFromStream(mApplictaion.getAssets().open("server.pem")).getSocketFactory();
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
