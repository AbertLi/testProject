...
public class HalfRingProgress extends View {
    ...
    public HalfRingProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    // 初始化圆弧画笔
    private void initHalfRingPaint() {
        mArcPaint = new Paint();
...
//        rectF.set(mArcWidth / 2f, mArcWidth / 2f, ws - mArcWidth / 2f, MeasureSpec.getSize(heightMeasureSpec) - mArcWidth / 2f);
    ...
    private class OnClickListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            ...
            // 事件回调
            if (null != mOnProgressChangeListener) {
                mOnProgressChangeListener.onProgressChanged(HalfRingProgress.this, getProgress(), true);
                mOnProgressChangeListener.onStopTrackingTouch(HalfRingProgress.this);
            }
            return true;
        }
    }
    ...
    public interface OnProgressChangeListener {
         ...
         */
        void onProgressChanged(HalfRingProgress seekBar, int progress, boolean isUser);
         ...
         * @param seekBar 拖动条
         */
        void onStartTrackingTouch(HalfRingProgress seekBar);
         ...
         * @param seekBar 拖动条
         */
        void onStopTrackingTouch(HalfRingProgress seekBar);
    }
    // endregion -----------------------------------------------------------------------------------
}
